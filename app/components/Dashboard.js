  ...
  return (
    ...
    <div className='container mx-auto py-5 px-6 '>
                ...
                <form className="max-w-2xl mx-auto" action={handleSubmit}>
                    ...
                    {/* Submit Button  */}
                    <div className="my-6">
                        <button type="submit" class="text-white bg-gradient-to-r from-blue-500 via-blue-600 to-blue-700 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium rounded-lg text-sm px-4 py-2.5 text-center leading-5">Save</button>
                    </div>
                </form>
