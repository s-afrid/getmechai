  ...
  return (
    <nav className='bg-gray-900 text-white flex justify-between px-4 h-16 items-center'>
        ...
        <div className='relative'>
          ...
          <div id="dropdown" className={`z-10 ${showdropdown? "": "hidden"} absolute left-[20px] top-[50px] bg-white divide-y divide-gray-100 rounded-lg shadow w-30 dark:bg-gray-700 cursor-pointer`}>
